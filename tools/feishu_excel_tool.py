...
from tools.feishu_excel.parser import download_file, parse_single_file
from tools.feishu_excel.messages import build_message
        ...
        try:
            if files:
                ...
                for fname, content in files:
                    entry = parse_single_file(fname, content)
                    if entry:
