...
三个数据工具——[分时汇报](https://github.com/Anakin7n/feishu-bot)、[地面任务分析](https://github.com/Anakin7n/ReelClean-bot)、[排片占比预测](https://github.com/Anakin7n/Prediction-Bot)——功能各异、参数繁杂。用户需要记住**哪个工具干什么、参数什么格式怎么排**——

- "2万"还是"20000"？"32.8"还是"32.8%"？格式错一处就失败，无提示
- "封神2"不行，得写"封神第二部：战火西岐"——影片名必须和猫眼逐字一致。像熊出没这种每年一部的系列，只说"熊出没"压根不知道是哪部
